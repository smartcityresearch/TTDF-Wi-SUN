...
sl_status_t sl_iostream_eusart_init_exp(void)
{
  ...
  if (!uart_config_exp.sw_flow_control) {
    switch (SL_IOSTREAM_EUSART_EXP_FLOW_CONTROL_TYPE)
    {
  ...
  sl_cos_config_vcom((uint32_t) SL_IOSTREAM_EUSART_EXP_BAUDRATE, flow_control);
