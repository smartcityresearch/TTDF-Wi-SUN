...
#define APP_VERSION_STRING "V1.2.1"
...
static const sl_wisun_connection_params_t sl_wisun_params_profile_special = {
    ...
    .discovery = {
        .trickle_pa = {
            ...
            .imax_s = 60,
            .k = 1},
        .trickle_pas = {.imin_s = 10, .imax_s = 60, .k = 1},
        .eapol_target_min_sens = DBM_TO_RSL_RANGE(-60),
        .allow_skip = true},
    .configuration = {.trickle_pc = {.imin_s = 10, .imax_s = 60, .k = 1}, .trickle_pcs = {.imin_s = 10, .imax_s = 60, .k = 1}},
    .eapol = {.sec_prot_trickle = {
                  .imin_s = 0,
                  .imax_s = 0,
                  .k = 0,
              },
    ...
    .direct_connect_eapol = {.pmk_lifetime_m = 0, .ptk_lifetime_m = 0, .sec_prot_retry_timeout_s = 0, .initial_key_min_s = 0, .initial_key_max_s = 3, .initial_key_retry_min_s = 10, .initial_key_retry_max_s = 0, .initial_key_retry_max_limit_s = 30, .gtk_request_imin_m = 0, .gtk_request_imax_m = 0, .gtk_max_mismatch_m = 64, .initial_key_retry_limit = 3, .allow_skip = false},
    .traffic = {
        .lowpan_mtu = 1576,
        .ipv6_mru = 1504,
